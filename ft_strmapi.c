...
/*   Updated: 2023/10/30 20:32:22 by mguardia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param f The parameter `f` is a function pointer that takes two arguments: an unsigned integer `i`
 * and a character `s[i]`. The function `f` is expected to return a character.
 * 
 * @return a dynamically allocated string (char *) that has been modified by the function f.
 */
