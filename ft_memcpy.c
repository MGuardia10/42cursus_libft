...
/*   Updated: 2023/10/30 20:28:21 by mguardia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * The function ft_memcpy copies n bytes from the memory area pointed to by src to the memory area
 * pointed to by dst.
 * 
 ...
 * be copied.
 * @param n The parameter `n` represents the number of bytes to be copied from the source memory
